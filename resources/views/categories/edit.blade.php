            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="padding: 30px;">
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input value="{{ old('category_name', $category->category_name) }}" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-category-name" type="text" name="category_name">
                        </div>
