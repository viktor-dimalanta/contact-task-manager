                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" style="table-layout: fixed;">
                        ...
                        <tbody>
                            @foreach ($businesses as $business)
                                <tr>
                                    <td class="px-6 py-4 truncate" style="width: 300px;"><a href="{{ route('businesses.show', $business->id) }}" class="text-yellow-500 hover:text-yellow-700 ml-2">{{ $business->business_name }}</a></td>
                                    <td class="px-6 py-4 truncate">{{ $business->email }}</td>
